...
def run_quant():
    ...
    if spec_llm is None:
        print("\nErreur: le LLM n'a pas renvoyé un JSON exploitable.")
        print("Réponse brute:")
        print(raw)
        return 1
...
print("1- Générer des articles (PDF/ODT)")
print("2- Générer un dataset (PDF/ODT) ")
print("0- Quitter")
choix = input("\nTon choix : ").strip()
...
if choix == "1":
    ...
    print(" Choix invalide. Tapez 1, 2, ou 0.")
